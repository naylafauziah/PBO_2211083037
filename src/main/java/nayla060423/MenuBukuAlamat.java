...
public class MenuBukuAlamat {
    public static void main(String[] args){
        DataBukuAlamat namaRecord = new DataBukuAlamat();
                ...
                switch(Integer.parseInt(PIL)){
                    case 1 :
                        ...
                        for(int i=0; i<jumlah; i++){
                            ...
                            System.out.print("mMasukkan Email : ");
                            try{
                        ...
                        for(int i = 0; i<jumlah; i++){
                            namaRecord.setName(nama[i],alamat[i],telp[i],email[i]);
                            System.out.println("==========================================");
                    ...
                    case 2:
                        ...
                        System.out.println("Ditemukn Data ke- "+no);
                        no = no-1;
